    ...
    public void show(Stage primaryStage) {
        ...
        loginButton.setOnAction(a -> {
            ...
            try {
                ...
                if(!(databaseHelper.isUserBanned(user))) {
                    if(role!=null) {
                        user.setRole(role);
        ...
        try {
            if (!databaseHelper.doesUserExist("staffuser")) {
                databaseHelper.register(new User("staffuser", "staffpass", "staff"));
                System.out.println("Test staff user created: staffuser / staffpass");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
